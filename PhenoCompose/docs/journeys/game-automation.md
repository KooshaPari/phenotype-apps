...
_Cost per test = (hardware cost / tests) + (time × electricity cost)_
...
_For issues with Steam authentication, see [Troubleshooting: Steam Rate Limits](../guide/troubleshooting.md#steam-rate-limits)_

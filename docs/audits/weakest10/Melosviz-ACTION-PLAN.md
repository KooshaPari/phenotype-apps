# ACTION-PLAN: Melosviz

> **Generated 2026-06-16.** Current mean: **0.15 / 3.0**. Owner TBD.
> Repo path: `/Users/kooshapari/CodeProjects/Phenotype/repos/Melosviz`
...
`A1 A2 A3 A4 AP1 AP2 AS1 AS2 AT1 AT2 AT3 AT4 AT5 AU1 AU2 C2 C3 CF1 CF2 CN1 CN2 CN3 D1 D2 D3 D6 DA1 DA2 DA3 DM2 E1 E2 E3 E4 E5 EH1 EH2 G1 O2 O3 O4 O5 OB1 OB2 OB3 OB4 P1 P2 P3 P4 P5 PR1 PR2 PS1 PS2 Q2 Q3 Q4 RE1 RE2 RL1 RL2 RL3 RT1 RT2 S1 S2 S3 S4 S5 S6 S7 S8 S9 SC1 SC2 SC3 SC4 T1 T2 T3 T4 T5 T6 U1 U3 U4 UX1 UX2 UX3 X1 X2 X3 X4 X5 X6 A5 D5 DM1 G2 G3 G4 G5 G6 Q1 U2`

Total weak pillars: 106

## Re-score trigger

After tasks 1-8 are complete, re-score Melosviz:
```bash
# 1. Commit the changes
cd /Users/kooshapari/CodeProjects/Phenotype/repos/Melosviz
git add -A && git commit -m 'feat(Melosviz): add quick-win governance/security/testing files'
# 2. Re-run audit scoring script
python3 /Users/kooshapari/CodeProjects/Phenotype/repos/docs/audits/scripts/score.py Melosviz
...
- If Melosviz is a foundational lib, consider extracting governance templates to `phenoShared`

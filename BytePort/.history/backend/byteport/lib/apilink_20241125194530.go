...
func ValidateGithub(apiURL, authMethod, authKey string) error {
	fmt.Println("Validating GitHub cloud connection...")
	//you need the git username for below request apiurl/user/username/repos
}
...
func ValidateGit(apiURL, appID string, privateKey []byte, installationID string) error {
